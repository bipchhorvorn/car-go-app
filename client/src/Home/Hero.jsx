        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6 header-img-section">
              <img src={hero} alt="Hello CarGo" className="img-fluid" />
            </div>
            <div className="col-md-6 my-5 my-md-0 text-center text-md-start">
              ...
              <h1 className="banner-title">
                Driving Dreams into <span>Reality</span> with us
              </h1>
              <p
                className="banner-title-text "
                style={{ textAlign: "justify" }}
              >
                Experience car buying like never before. CarGo offers an
                extensive range of options, unbeatable deals, expert guidance,
                and a hassle-free journey to your dream car. Discover, compare,
